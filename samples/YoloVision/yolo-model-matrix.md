...
| YOLOv8 | det, cls, seg, obb, pose | Official YOLOv8n classification, segmentation, embedded pose, and embedded-angle OBB source-tree proofs; detection requires a separate audited asset. |
