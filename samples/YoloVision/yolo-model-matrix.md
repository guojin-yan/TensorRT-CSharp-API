...
| YOLOv8 | det, cls, seg, obb, pose | Official YOLOv8n segmentation, embedded pose, and embedded-angle OBB source-tree proofs; detection/classification require separate audited assets. |
