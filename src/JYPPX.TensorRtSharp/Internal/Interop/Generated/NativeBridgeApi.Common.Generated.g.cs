...
internal static partial class NativeBridgeApi
{
    ...
    {
        NativeStatus.ThrowIfFailed(NativeMethodsCommon.jyppx_common_get_build_info(out NativeBuildInfo value));
        return value;
    }

    public static NativeRuntimeInfo GetRuntimeInfo()
    {
        NativeStatus.ThrowIfFailed(NativeMethodsCommon.jyppx_common_query_runtime_info(out NativeRuntimeInfo value));
        return value;
    }

    public static NativeCapabilityInfo GetCapabilityInfo()
    {
        NativeStatus.ThrowIfFailed(NativeMethodsCommon.jyppx_common_query_capability_info(out NativeCapabilityInfo value));
        return value;
    }
