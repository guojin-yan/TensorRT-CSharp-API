...
public static class TrtexecLikeOptionCapabilities
{
    public static IReadOnlyList<TrtexecLikeOptionCapability> Entries { get; } =
        new[]
        {
            ...
            new TrtexecLikeOptionCapability("--loadInputs/--dumpOutput/--dumpRawBindingsToFile", "runtime-artifacts", "bounded-artifact", "bounded-runtime-artifact", "Runtime artifacts require real expected output and owner evidence before promotion."),
            new TrtexecLikeOptionCapability("--exportOutput/--exportTimes/--exportProfile/--saveProfile", "runtime-artifacts", "bounded-artifact", "bounded-runtime-artifact", "Exported runtime-shaped artifacts are not package-consumer runtime proof."),
