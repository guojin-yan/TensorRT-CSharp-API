...
static string GetManagedType(ManifestParameterRecord parameter, bool moduleSpecific)
{
    ...
    return parameter.NativeType switch
    {
        ...
        "JYPPX_TensorRtDebugListenerOwner**" => moduleSpecific ? "out SafeTensorRtObjectHandle" : "out IntPtr",
        ...
        "JYPPX_TensorRtDebugListenerOwner*" => moduleSpecific ? "SafeTensorRtObjectHandle" : "IntPtr",
        ...
        "JYPPX_TensorRtDebugListenerOwnerInfo*" when string.Equals(parameter.Direction, "out", StringComparison.OrdinalIgnoreCase) => moduleSpecific ? "out NativeTensorRtDebugListenerOwnerInfo" : "out IntPtr",
