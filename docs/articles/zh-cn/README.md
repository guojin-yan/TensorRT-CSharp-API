...
2026-08-05 清理后保留 330 个 Markdown 文件。严格发布目录当前收录 10 篇文章，这 10 篇都具备真实程序运行窗口截图和原图叠加识别结果，并由外层 `models` 目录中的 ONNX 对应支撑；其余 320 篇仍是项目文档、内部记录、非视觉实机教程或待完善稿。数量代表项目过程材料多，不代表有 330 篇完整成稿。
