...
- loaded engine 诊断模型：`src/JYPPX.TensorRtSharp.Tools/OnnxEngineBuildResult.cs`。
- engine readback artifact：`src/JYPPX.TensorRtSharp.Tools/OnnxEngineRuntimeArtifactWriter.cs`。
