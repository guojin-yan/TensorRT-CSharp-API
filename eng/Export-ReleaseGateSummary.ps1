...
$lines.Add("- Managed, bridge, vendor component, and collection packages are versioned independently; routine C# releases should not republish stable NVIDIA component packages.")
