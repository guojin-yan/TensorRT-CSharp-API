...
$items.Add((New-ValidationItem -Id "source-links" -Passed ($sourceCodeSampleLinks -contains "samples/YoloVision" -and $sourceCodeSampleLinks -contains "samples/OnnxToEngine" -and $sourceCodeSampleLinks -contains "applications/TensorRtExec" -and $sourceCodeSampleLinks -contains "src/JYPPX.TensorRtSharp") -Severity "blocker" -Detail "Campaign must link YoloVision, OnnxToEngine, TensorRtExec, and core wrapper source paths.")) | Out-Null
