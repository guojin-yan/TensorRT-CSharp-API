...
Write-Utf8File -LiteralPath $templateJsonPath -InputObject ($template | ConvertTo-Json -Depth 20)
Write-Utf8File -LiteralPath $exampleJsonPath -InputObject ($example | ConvertTo-Json -Depth 20)
