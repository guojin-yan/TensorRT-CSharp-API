...
function Find-ExplicitTensorRtInterfaceAliasApis {
  ...
  $aliasMap = @{
    ...
    "IBuilderConfig::getTilingOptimizationLevel" = @("id:*builder-config-get-tiling-optimization-level")
    "IBuilderConfig::getL2LimitForTiling" = @("id:*builder-config-get-l2-limit-for-tiling")
    "IBuilderConfig::getMaxNbTactics" = @("id:*builder-config-get-max-nb-tactics")
    ...
    "IExecutionContext::getNvtxVerbosity" = @("id:*execution-context-get-nvtx-verbosity")
    ...
    "ICudaEngine::hasImplicitBatchDimension" = @("id:*cuda-engine-has-implicit-batch-dimension", "id:*cuda-engine-has-implicit-batch-dimension-legacy-alias")
  ...
  $deferredHistoryAliasMap = @{
    ...
    "IExecutionContext::getErrorBuffer" = @("id:*execution-context-get-error-buffer-deferred")
    "IBuilderConfig::getTilingOptimizationLevel" = @("id:*builder-config-get-tiling-optimization-level-deferred")
    "IBuilderConfig::setTilingOptimizationLevel" = @("id:*builder-config-set-tiling-optimization-level-deferred")
    "ICudaEngine::hasImplicitBatchDimension" = @("id:*cuda-engine-has-implicit-batch-dimension-deferred")
    "IParser::getError" = @("id:*parser-refitter-get-error-deferred")
    "IParserRefitter::getError" = @("id:*parser-refitter-get-error", "id:*parser-refitter-get-error-count", "id:*parser-refitter-get-error-deferred")
