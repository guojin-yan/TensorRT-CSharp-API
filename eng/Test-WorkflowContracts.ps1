...
$workflowContracts = @(
  ...
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle "JYPPX.TensorRT.CSharp.API.YoloVision" -Description "YoloVision managed extension package"
      New-Requirement -Needle "Test-YoloVisionPackageSurface.ps1" -Description "YoloVision package surface validation"
      New-Requirement -Needle "Test-YoloVisionManagedPackageDryRun.ps1" -Description "YoloVision clean managed package consumer"
