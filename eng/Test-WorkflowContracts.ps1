...
$workflowContracts = @(
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle "owner_publish_approved" -Description "explicit Owner documentation deployment approval"
      New-Requirement -Needle "name: production-release" -Description "protected production release Environment"
      New-Requirement -Needle "Test-ProductionReleaseEnvironment.ps1" -Description "fail-closed production Environment readiness gate"
  ...
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle "JYPPX.TensorRT.CSharp.API" -Description "core managed API package"
      New-Requirement -Needle "FullyQualifiedName~YoloVisionManagedPackagePublicationTests" -Description "bounded managed publication contract tests"
      New-Requirement -Needle "RequireExactPackageSet" -Description "strict managed package allowlist"
      New-Requirement -Needle "owner_publish_approved" -Description "explicit Owner publication approval"
  ...
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle "owner_publish_approved" -Description "explicit Owner publication approval"
      New-Requirement -Needle "Package or Release publication requires owner_publish_approved=true" -Description "publication side-effect guard"
      New-Requirement -Needle "Push-NuGetPackages.ps1" -Description "package publication"
    )
  }
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle "githubcli-archive-keyring.gpg" -Description "GitHub CLI repository is bootstrapped inside Ubuntu containers"
      New-Requirement -Needle "apt-get install -y --no-install-recommends powershell gh" -Description "GitHub CLI is installed inside Ubuntu containers"
      New-Requirement -Needle "Verify GitHub CLI" -Description "GitHub CLI availability is validated before release upload"
  ...
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle "owner_publish_approved" -Description "explicit Owner publication approval"
      New-Requirement -Needle "Publishing managed or Bridge packages to nuget.org requires the repository secret NUGET_API_KEY" -Description "managed and Bridge nuget.org secret preflight"
      ...
      New-Requirement -Needle "Push-NuGetPackages.ps1" -Description "centralized package publication"
      New-Requirement -Needle "publish_to_nuget=false" -Description "child workflows are build-only"
      New-Requirement -Needle "attach_to_github_release=false" -Description "child workflows cannot mutate the centralized Release"
      New-Requirement -Needle "exactly 19 NuGet packages: 1 managed package and 18 Bridge packages" -Description "exact formal package inventory guard"
      New-Requirement -Needle "fixed 6 Windows + 12 Linux runtime manifest" -Description "exact runtime matrix inventory guard"
      New-Requirement -Needle 'TensorRtSharp4.0-source-$RELEASE_VERSION.zip' -Description "exact source archive guard"
      New-Requirement -Needle "TensorRT-CSharp-API $RELEASE_VERSION" -Description "stable Release title"
      New-Requirement -Needle 'docs/releases/$RELEASE_VERSION.md' -Description "versioned Release notes"
      New-Requirement -Needle "--draft" -Description "incomplete Release stays private while assets upload"
      New-Requirement -Needle "draft:false" -Description "public non-draft Release enforcement"
      New-Requirement -Needle "prerelease:false" -Description "stable non-prerelease enforcement"
      New-Requirement -Needle "gh workflow run docs-release.yml" -Description "post-release API documentation deployment"
      ...
      New-Requirement -Needle 'attach_to_github_release=false' -Description "centralized Release mutation boundary"
      New-Requirement -Needle "Publishing managed or Bridge packages to nuget.org requires the repository secret NUGET_API_KEY" -Description "nuget.org secret guard before child workflow dispatch"
    )
  }
  [pscustomobject]@{
  ...
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle 'default: "4.0.0-preview.1"' -Description "current managed package version is audited by default"
      New-Requirement -Needle 'default: "v4.0.0-preview.1"' -Description "current release tag and strict inventory are audited by default"
      New-Requirement -Needle "runtime_release_tags" -Description "runtime assets attached to the current release can be audited explicitly"
  ...
  [pscustomobject]@{
    ...
    requirements = @(
      ...
      New-Requirement -Needle 'gate = "required"' -Description "required readiness gates still fail hard"
      New-Requirement -Needle 'gate = "advisory"' -Description "future and runner readiness rows are advisory"
      New-Requirement -Needle "blockingNotReadyCount" -Description "blocking readiness count is reported separately"
      New-Requirement -Needle "future-target:linux-arm64-sbsa" -Description "future SBSA readiness advisory"
      New-Requirement -Needle "future-target:linux-jetson-l4t" -Description "future Jetson readiness advisory"
      New-Requirement -Needle "future-target:non-ubuntu-linux" -Description "future non-Ubuntu readiness advisory"
