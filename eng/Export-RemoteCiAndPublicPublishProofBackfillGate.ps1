...
$lanes = @(
  ...
  New-BackfillLane -Id "github-actions-run-proof" -Artifact "artifacts/final-release/github-actions-run-evidence-import.json" -Record (Read-JsonOrNull "artifacts\final-release\github-actions-run-evidence-import.json") -StateProperty "evidenceState" -DefaultState "missing-github-actions-run-evidence-import" -ReadyStates @("github-actions-run-evidence-ready") -RequiredEvidence "Real GitHub Actions workflow run URL, run id, head SHA, conclusion, log hash, and artifact hash." -RequireProofReady $false
  ...
  New-BackfillLane -Id "public-package-download-proof" -Artifact "artifacts/final-release/public-package-download-proof-input-validation.json" -Record $publicPackageDownloadProofValidation -StateProperty "validationState" -DefaultState "missing-public-package-download-proof-input-validation" -ReadyStates @("public-package-download-proof-input-ready") -RequiredEvidence "Downloaded public package URL/source, SHA256, package identity, and non-local source proof." -RequireProofReady $false
