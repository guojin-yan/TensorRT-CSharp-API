...
$items = @(
  ...
  New-OwnerValidationItem "convergence-cross-check" ([bool](Get-PropertyOrDefault -Object $record -Name "realOwnerProofConvergenceStructurallyReady" -DefaultValue $false) -and [int](Get-PropertyOrDefault -Object $record -Name "convergencePostPublishLaneCount" -DefaultValue 0) -eq [int](Get-PropertyOrDefault -Object $record -Name "laneCount" -DefaultValue -1) -and [int](Get-PropertyOrDefault -Object $record -Name "convergencePostPublishAcceptedLaneCount" -DefaultValue -1) -eq [int](Get-PropertyOrDefault -Object $record -Name "proofReadyLaneCount" -DefaultValue -2)) "blocker" "Bridge and unified convergence dashboard must agree on post-publish lanes."
...
$validation = [pscustomobject]@{
  ...
  realOwnerProofConvergenceStructurallyReady = [bool](Get-PropertyOrDefault -Object $record -Name "realOwnerProofConvergenceStructurallyReady" -DefaultValue $false)
  convergencePostPublishLaneCount = [int](Get-PropertyOrDefault -Object $record -Name "convergencePostPublishLaneCount" -DefaultValue 0)
  convergencePostPublishAcceptedLaneCount = [int](Get-PropertyOrDefault -Object $record -Name "convergencePostPublishAcceptedLaneCount" -DefaultValue 0)
