...
| `bounded-benchmark-scheduler` | `--iterations --warmUp --duration --streams --infStreams --idleTime --avgRuns --percentile` | implemented-bounded-runtime | Independent context/bindings/stream owners execute bounded scheduling and GPU event timing; model correctness and package-consumer proof remain external. |
