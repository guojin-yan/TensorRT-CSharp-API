...
public static class TensorRtExecCommand
{
    ...
    private static void PrintUsage()
    {
        ...
        System.Console.WriteLine("  --fp16 --int8 --bf16 --noTF32 --workspace <MiB>");
        ...
        System.Console.WriteLine("  --plugins <dll1;dll2> --timingCacheFile <path>");
        ...
        System.Console.WriteLine("  --noDataTransfers --useSpinWait --threads <n> --avgRuns <n> --percentile <0..100>");
