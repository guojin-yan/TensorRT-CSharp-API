...
`applications/YoloVision/yolo-model-matrix.json` is the machine-readable support matrix for the unified YOLO sample. It covers YOLOv5, YOLOv6, YOLOv7, YOLOv8, YOLOv9, YOLOv10, YOLOv11, YOLOv26, detection-only YOLOX, and custom models across `det`, `cls`, `seg`, `obb`, `pose`, and `sem`.
