...
internal static class Program
{
    ...
    private static void PrintUsage()
    {
        ...
        Console.WriteLine("  dotnet run --project applications/OnnxToEngine -- --tensor-rt-line 10 --batch 2");
        Console.WriteLine("  dotnet run --project applications/OnnxToEngine -- --onnx model.onnx --saveEngine model.plan --minShapes input:1x3x640x640 --optShapes input:1x3x640x640 --maxShapes input:4x3x640x640 --buildOnly");
        Console.WriteLine("  dotnet run --project applications/OnnxToEngine -- --mnist --tensor-rt-line 10 --onnx mnist.onnx --mnistInput 7.pgm --expectedDigit 7 --saveEngine mnist.plan --exportReport mnist-report.json --exportOutput mnist-output.json --exportPreprocessedInput mnist-input.bin --visualization mnist-result.svg");
        Console.WriteLine("  dotnet run --project applications/OnnxToEngine -- --help-json");
