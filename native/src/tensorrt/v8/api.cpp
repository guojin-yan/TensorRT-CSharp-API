...
namespace
{
constexpr JYPPX_TensorRtLine kLine = JYPPX_TENSORRT_LINE_8;
...
void destroy_onnx_config_payload(void* payload)
{
    ...
    static_cast<nvonnxparser::IOnnxConfig*>(payload)->destroy();
#else
...
void destroy_runtime_payload(void* payload)
{
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    static_cast<nvinfer1::IRuntime*>(payload)->destroy();
#else
    delete static_cast<nvinfer1::IRuntime*>(payload);
#endif
}

void destroy_builder_payload(void* payload)
{
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    static_cast<nvinfer1::IBuilder*>(payload)->destroy();
#else
    delete static_cast<nvinfer1::IBuilder*>(payload);
#endif
}

void destroy_builder_config_payload(void* payload)
{
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    static_cast<nvinfer1::IBuilderConfig*>(payload)->destroy();
#else
    delete static_cast<nvinfer1::IBuilderConfig*>(payload);
#endif
}

void destroy_network_payload(void* payload)
{
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    static_cast<nvinfer1::INetworkDefinition*>(payload)->destroy();
#else
    delete static_cast<nvinfer1::INetworkDefinition*>(payload);
#endif
}

void destroy_host_memory_payload(void* payload)
{
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    static_cast<nvinfer1::IHostMemory*>(payload)->destroy();
#else
    delete static_cast<nvinfer1::IHostMemory*>(payload);
#endif
}

void destroy_engine_payload(void* payload)
{
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    static_cast<nvinfer1::ICudaEngine*>(payload)->destroy();
#else
    delete static_cast<nvinfer1::ICudaEngine*>(payload);
#endif
}

void destroy_execution_context_payload(void* payload)
{
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    static_cast<nvinfer1::IExecutionContext*>(payload)->destroy();
#else
    delete static_cast<nvinfer1::IExecutionContext*>(payload);
#endif
}
...
{
    delete static_cast<nvonnxparser::IParser*>(payload);
}
#endif
...
#if JYPPX_HAS_TENSORRT && JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
nvinfer1::IRNNv2Layer* get_rnn_v2_layer_payload(const JYPPX_TensorRtObjectBase* object)
{
    auto* layer = get_layer_payload(object);
    if (layer == nullptr || layer->getType() != nvinfer1::LayerType::kRNN_V2)
    {
        return nullptr;
    }

    return static_cast<nvinfer1::IRNNv2Layer*>(layer);
}
#endif
...
#define JYPPX_TRT8_VALIDATE_NAMED_TENSOR_DEFINED 1
...
JYPPX_StatusCode jyppx_trt8_query_adapter_info(JYPPX_TensorRtAdapterInfo* out_info)
{
...
JYPPX_StatusCode jyppx_trt8_logger_create(JYPPX_TensorRtLogger** out_logger)
{
...
JYPPX_StatusCode jyppx_trt8_logger_create_with_callback(
...
JYPPX_StatusCode jyppx_trt8_logger_emit_diagnostic(
...
JYPPX_StatusCode jyppx_trt8_profiler_create_with_callback(
...
JYPPX_StatusCode jyppx_trt8_profiler_emit_diagnostic(
...
JYPPX_StatusCode jyppx_trt8_runtime_create(JYPPX_TensorRtLogger* logger, JYPPX_TensorRtRuntime** out_runtime)
{
    ...
    *out_runtime = nullptr;
    ...
    JYPPX_TensorRtObjectBase* handle = nullptr;
    status = create_handle_with_payload(&handle, JYPPX_TENSORRT_OBJECT_KIND_RUNTIME, runtime, &destroy_runtime_payload);
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }
...
JYPPX_StatusCode jyppx_trt8_builder_create(JYPPX_TensorRtLogger* logger, JYPPX_TensorRtBuilder** out_builder)
{
    ...
    *out_builder = nullptr;
    ...
    JYPPX_TensorRtObjectBase* handle = nullptr;
    status = create_handle_with_payload(&handle, JYPPX_TENSORRT_OBJECT_KIND_BUILDER, builder, &destroy_builder_payload);
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }
...
JYPPX_StatusCode jyppx_trt8_builder_platform_has_fast_fp16(JYPPX_TensorRtBuilder* builder, JYPPX_Boolean* out_supported)
{
...
JYPPX_StatusCode jyppx_trt8_builder_platform_has_fast_int8(JYPPX_TensorRtBuilder* builder, JYPPX_Boolean* out_supported)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_supported, "out_supported");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_builder_platform_has_tf32(JYPPX_TensorRtBuilder* builder, JYPPX_Boolean* out_supported)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_supported, "out_supported");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_builder_get_dla_core_count(JYPPX_TensorRtBuilder* builder, int32_t* out_count)
{
...
JYPPX_StatusCode jyppx_trt8_builder_get_max_dla_batch_size(JYPPX_TensorRtBuilder* builder, int32_t* out_size)
{
...
JYPPX_StatusCode jyppx_trt8_builder_get_max_batch_size(JYPPX_TensorRtBuilder* builder, int32_t* out_max_batch_size)
{
    ...
    *out_max_batch_size = builder_payload->getMaxBatchSize();
    return JYPPX_STATUS_OK;
#elif JYPPX_HAS_TENSORRT
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "builder maximum batch size query");
#else
    return jyppx::tensorrt::report_vendor_missing(kLine, "builder maximum batch size query");
#endif
}

JYPPX_StatusCode jyppx_trt8_builder_set_max_threads(JYPPX_TensorRtBuilder* builder, int32_t max_threads, JYPPX_Boolean* out_set)
{
...
JYPPX_StatusCode jyppx_trt8_builder_get_max_threads(JYPPX_TensorRtBuilder* builder, int32_t* out_max_threads)
{
...
JYPPX_StatusCode jyppx_trt8_builder_is_network_supported(
...
JYPPX_StatusCode jyppx_trt8_builder_create_config(JYPPX_TensorRtBuilder* builder, JYPPX_TensorRtBuilderConfig** out_config)
{
    ...
    *out_config = nullptr;
    ...
    JYPPX_TensorRtObjectBase* handle = nullptr;
    status = create_handle_with_payload(&handle, JYPPX_TENSORRT_OBJECT_KIND_BUILDER_CONFIG, config, &destroy_builder_config_payload);
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }
...
JYPPX_StatusCode jyppx_trt8_builder_create_network(JYPPX_TensorRtBuilder* builder, uint32_t creation_flags, JYPPX_TensorRtNetworkDefinition** out_network)
{
    ...
    *out_network = nullptr;
    ...
    uint32_t effective_flags = creation_flags;
    if (effective_flags == 0)
    {
        effective_flags = 1U << static_cast<uint32_t>(nvinfer1::NetworkDefinitionCreationFlag::kEXPLICIT_BATCH);
    }

    nvinfer1::NetworkDefinitionCreationFlags flags = static_cast<nvinfer1::NetworkDefinitionCreationFlags>(effective_flags);
    ...
    JYPPX_TensorRtObjectBase* handle = nullptr;
    status = create_handle_with_payload(&handle, JYPPX_TENSORRT_OBJECT_KIND_NETWORK_DEFINITION, network, &destroy_network_payload);
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }
...
JYPPX_StatusCode jyppx_trt8_builder_build_serialized_network(JYPPX_TensorRtBuilder* builder, JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtBuilderConfig* config, JYPPX_TensorRtHostMemory** out_host_memory)
{
    ...
    *out_host_memory = nullptr;
    ...
    JYPPX_TensorRtObjectBase* handle = nullptr;
    status = create_handle_with_payload(&handle, JYPPX_TENSORRT_OBJECT_KIND_HOST_MEMORY, host_memory, &destroy_host_memory_payload);
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }
...
JYPPX_StatusCode jyppx_trt8_host_memory_get_size(JYPPX_TensorRtHostMemory* host_memory, size_t* out_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_size, "out_size");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_host_memory_copy_to_buffer(JYPPX_TensorRtHostMemory* host_memory, void* destination, size_t destination_size, size_t* out_bytes_written)
{
...
JYPPX_StatusCode jyppx_trt8_runtime_deserialize_engine(JYPPX_TensorRtRuntime* runtime, const void* engine_data, size_t engine_size, JYPPX_TensorRtCudaEngine** out_engine)
{
    ...
    *out_engine = nullptr;
    ...
    JYPPX_TensorRtObjectBase* handle = nullptr;
    status = create_handle_with_payload(&handle, JYPPX_TENSORRT_OBJECT_KIND_CUDA_ENGINE, engine, &destroy_engine_payload);
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }
...
JYPPX_StatusCode jyppx_trt8_runtime_deserialize_host_memory(JYPPX_TensorRtRuntime* runtime, JYPPX_TensorRtHostMemory* host_memory, JYPPX_TensorRtCudaEngine** out_engine)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_engine, "out_engine");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    *out_engine = nullptr;
    ...
    return jyppx_trt8_runtime_deserialize_engine(
        runtime,
...
JYPPX_StatusCode jyppx_trt8_engine_serialize(JYPPX_TensorRtCudaEngine* engine, JYPPX_TensorRtHostMemory** out_host_memory)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_host_memory, "out_host_memory");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_engine_get_io_tensor_count(JYPPX_TensorRtCudaEngine* engine, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_engine_get_io_tensor_info(JYPPX_TensorRtCudaEngine* engine, int32_t index, JYPPX_TensorRtTensorInfo* out_info)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_info, "out_info");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    const int32_t count = engine_payload->getNbBindings();
    if (index >= count)
    {
    ...
    const char* name = engine_payload->getBindingName(index);
    if (name == nullptr)
    {
        return report_null_vendor_object("getBindingName");
    }

    std::memset(out_info, 0, sizeof(*out_info));
    out_info->index = index;
    copy_tensor_name(name, out_info->name);
    out_info->data_type = static_cast<int32_t>(engine_payload->getBindingDataType(index));
    out_info->io_mode = engine_payload->bindingIsInput(index) ? JYPPX_TENSORRT_IO_MODE_INPUT : JYPPX_TENSORRT_IO_MODE_OUTPUT;
    copy_dims(engine_payload->getBindingDimensions(index), &out_info->shape);
    return JYPPX_STATUS_OK;
#elif JYPPX_HAS_TENSORRT
    std::memset(out_info, 0, sizeof(*out_info));
...
JYPPX_StatusCode jyppx_trt8_engine_get_device_memory_size(JYPPX_TensorRtCudaEngine* engine, size_t* out_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_size, "out_size");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    *out_size = engine_payload->getDeviceMemorySize();
    return JYPPX_STATUS_OK;
#elif JYPPX_HAS_TENSORRT
...
JYPPX_StatusCode jyppx_trt8_engine_get_device_memory_size_for_profile(JYPPX_TensorRtCudaEngine* engine, int32_t profile_index, size_t* out_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_size, "out_size");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    *out_size = 0;
    ...
    jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TensorRT 8 does not expose per-profile engine device memory size through this bridge.");
    return JYPPX_STATUS_NOT_SUPPORTED;
}

JYPPX_StatusCode jyppx_trt8_engine_get_device_memory_size_v2(JYPPX_TensorRtCudaEngine* engine, size_t* out_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_size, "out_size");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    *out_size = 0;
    ...
    jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TensorRT 8 does not expose ICudaEngine::getDeviceMemorySizeV2.");
    return JYPPX_STATUS_NOT_SUPPORTED;
}

JYPPX_StatusCode jyppx_trt8_engine_get_device_memory_size_for_profile_v2(JYPPX_TensorRtCudaEngine* engine, int32_t profile_index, size_t* out_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_size, "out_size");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    *out_size = 0;
    ...
    jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TensorRT 8 does not expose ICudaEngine::getDeviceMemorySizeForProfileV2.");
    return JYPPX_STATUS_NOT_SUPPORTED;
}

JYPPX_StatusCode jyppx_trt8_engine_get_nb_aux_streams(JYPPX_TensorRtCudaEngine* engine, int32_t* out_stream_count)
{
    ...
    *out_stream_count = 0;
    ...
    engine_payload = get_payload<nvinfer1::ICudaEngine>(engine);
    if (engine_payload == nullptr)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Engine handle does not carry a TensorRT engine payload.");
        return JYPPX_STATUS_INVALID_STATE;
...
JYPPX_StatusCode jyppx_trt8_engine_is_debug_tensor(JYPPX_TensorRtCudaEngine* engine, const char* tensor_name, JYPPX_Boolean* out_is_debug_tensor)
{
    ...
    *out_is_debug_tensor = JYPPX_FALSE;
    ...
    jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TensorRT 8 does not expose ICudaEngine::isDebugTensor.");
    return JYPPX_STATUS_NOT_SUPPORTED;
}

JYPPX_StatusCode jyppx_trt8_engine_get_optimization_profile_count(JYPPX_TensorRtCudaEngine* engine, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_engine_get_io_tensor_name(
...
JYPPX_StatusCode jyppx_trt8_engine_get_tensor_index(JYPPX_TensorRtCudaEngine* engine, const char* tensor_name, int32_t* out_index)
{
...
JYPPX_StatusCode jyppx_trt8_engine_get_tensor_data_type(JYPPX_TensorRtCudaEngine* engine, const char* tensor_name, int32_t* out_data_type)
{
...
JYPPX_StatusCode jyppx_trt8_engine_get_tensor_shape(JYPPX_TensorRtCudaEngine* engine, const char* tensor_name, JYPPX_TensorRtDims* out_shape)
{
...
JYPPX_StatusCode jyppx_trt8_engine_get_tensor_io_mode(JYPPX_TensorRtCudaEngine* engine, const char* tensor_name, int32_t* out_io_mode)
{
...
JYPPX_StatusCode jyppx_trt8_engine_create_execution_context(JYPPX_TensorRtCudaEngine* engine, JYPPX_TensorRtExecutionContext** out_context)
{
    ...
    *out_context = nullptr;
    ...
    JYPPX_TensorRtObjectBase* handle = nullptr;
    status = create_handle_with_payload(&handle, JYPPX_TENSORRT_OBJECT_KIND_EXECUTION_CONTEXT, context, &destroy_execution_context_payload);
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }
...
JYPPX_StatusCode jyppx_trt8_engine_create_execution_context_without_device_memory(JYPPX_TensorRtCudaEngine* engine, JYPPX_TensorRtExecutionContext** out_context)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_context, "out_context");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_builder_create_optimization_profile(JYPPX_TensorRtBuilder* builder, JYPPX_TensorRtOptimizationProfile** out_profile)
{
...
JYPPX_StatusCode jyppx_trt8_optimization_profile_set_shape(JYPPX_TensorRtOptimizationProfile* profile, const char* input_name, int32_t selector, const JYPPX_TensorRtDims* dims)
{
...
JYPPX_StatusCode jyppx_trt8_optimization_profile_get_shape(JYPPX_TensorRtOptimizationProfile* profile, const char* input_name, int32_t selector, JYPPX_TensorRtDims* out_dims)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_identity(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, JYPPX_TensorRtLayer** out_layer)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_constant(JYPPX_TensorRtNetworkDefinition* network, const JYPPX_TensorRtDims* dims, int32_t data_type, const void* values, size_t value_count, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_elementwise(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* left_tensor, JYPPX_TensorRtTensor* right_tensor, int32_t operation, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_matrix_multiply(
    JYPPX_TensorRtNetworkDefinition* network,
...
JYPPX_StatusCode jyppx_trt8_matrix_multiply_layer_set_operation(JYPPX_TensorRtLayer* layer, int32_t input_index, int32_t operation)
{
...
JYPPX_StatusCode jyppx_trt8_matrix_multiply_layer_get_operation(JYPPX_TensorRtLayer* layer, int32_t input_index, int32_t* out_operation)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_shuffle(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_set_reshape_dimensions(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* dims)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_get_reshape_dimensions(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_dims)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_dims, "out_dims");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_set_first_transpose(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* permutation)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_get_first_transpose(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_permutation)
{
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_set_second_transpose(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* permutation)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_get_second_transpose(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_permutation)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_permutation, "out_permutation");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_set_zero_is_placeholder(JYPPX_TensorRtLayer* layer, JYPPX_Boolean zero_is_placeholder)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_shuffle_layer_get_zero_is_placeholder(JYPPX_TensorRtLayer* layer, JYPPX_Boolean* out_zero_is_placeholder)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_reduce(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, int32_t operation, uint32_t axes, int32_t keep_dimensions, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_reduce_layer_get_operation(JYPPX_TensorRtLayer* layer, int32_t* out_operation)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_operation, "out_operation");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_reduce_layer_get_axes(JYPPX_TensorRtLayer* layer, uint32_t* out_axes)
{
...
JYPPX_StatusCode jyppx_trt8_reduce_layer_get_keep_dimensions(JYPPX_TensorRtLayer* layer, int32_t* out_keep_dimensions)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_concatenation(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor** input_tensors, int32_t input_count, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_concatenation_layer_set_axis(JYPPX_TensorRtLayer* layer, int32_t axis)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_concatenation_layer_get_axis(JYPPX_TensorRtLayer* layer, int32_t* out_axis)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_slice(
    JYPPX_TensorRtNetworkDefinition* network,
...
JYPPX_StatusCode jyppx_trt8_slice_layer_set_start(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* start)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_slice_layer_get_start(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_start)
{
...
JYPPX_StatusCode jyppx_trt8_slice_layer_set_size(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* size)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_slice_layer_get_size(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_size, "out_size");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_slice_layer_set_stride(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* stride)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_slice_layer_get_stride(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_stride)
{
...
JYPPX_StatusCode jyppx_trt8_slice_layer_set_mode(JYPPX_TensorRtLayer* layer, int32_t mode)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
#if JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    slice_layer->setMode(static_cast<nvinfer1::SliceMode>(mode));
    return JYPPX_STATUS_OK;
#else
    (void)slice_layer;
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "slice layer mode set");
#endif
#else
    (void)mode;
...
JYPPX_StatusCode jyppx_trt8_slice_layer_get_mode(JYPPX_TensorRtLayer* layer, int32_t* out_mode)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_softmax(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_softmax_layer_set_axes(JYPPX_TensorRtLayer* layer, uint32_t axes)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_softmax_layer_get_axes(JYPPX_TensorRtLayer* layer, uint32_t* out_axes)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_axes, "out_axes");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_unary(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, int32_t operation, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_unary_layer_get_operation(JYPPX_TensorRtLayer* layer, int32_t* out_operation)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_operation, "out_operation");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_topk(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, int32_t operation, int32_t k, uint32_t axes, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_topk_layer_get_operation(JYPPX_TensorRtLayer* layer, int32_t* out_operation)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_operation, "out_operation");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_topk_layer_get_k(JYPPX_TensorRtLayer* layer, int32_t* out_k)
{
...
JYPPX_StatusCode jyppx_trt8_topk_layer_get_axes(JYPPX_TensorRtLayer* layer, uint32_t* out_axes)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_axes, "out_axes");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_gather(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* data_tensor, JYPPX_TensorRtTensor* indices_tensor, int32_t axis, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_gather_layer_get_axis(JYPPX_TensorRtLayer* layer, int32_t* out_axis)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_axis, "out_axis");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_activation(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, int32_t activation_type, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    if (activation_type < 0 || activation_type > 11)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TensorRT 8 activation type must be between 0 and 11.");
        return JYPPX_STATUS_INVALID_ARGUMENT;
    }
...
JYPPX_StatusCode jyppx_trt8_activation_layer_get_type(JYPPX_TensorRtLayer* layer, int32_t* out_activation_type)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_pooling_nd(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, int32_t pooling_type, const JYPPX_TensorRtDims* window_size, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_get_type(JYPPX_TensorRtLayer* layer, int32_t* out_pooling_type)
{
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_window_size_nd(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* window_size)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_get_window_size_nd(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_window_size)
{
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_stride_nd(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* stride)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_get_stride_nd(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_stride)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_stride, "out_stride");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_padding_nd(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* padding)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_get_padding_nd(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_padding)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_resize(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_resize_layer_set_output_dimensions(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* dimensions)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_resize_layer_get_output_dimensions(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_dimensions)
{
...
JYPPX_StatusCode jyppx_trt8_resize_layer_set_mode(JYPPX_TensorRtLayer* layer, int32_t resize_mode)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_resize_layer_get_mode(JYPPX_TensorRtLayer* layer, int32_t* out_resize_mode)
{
...
JYPPX_StatusCode jyppx_trt8_resize_layer_set_scales(JYPPX_TensorRtLayer* layer, const float* scales, int32_t scale_count)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_resize_layer_get_scales(JYPPX_TensorRtLayer* layer, float* scales, int32_t scale_capacity, int32_t* out_scale_count)
{
...
JYPPX_StatusCode jyppx_trt8_network_add_shape(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtTensor* input_tensor, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_select(
    JYPPX_TensorRtNetworkDefinition* network,
...
JYPPX_StatusCode jyppx_trt8_network_add_fill(JYPPX_TensorRtNetworkDefinition* network, const JYPPX_TensorRtDims* dimensions, int32_t operation, JYPPX_TensorRtLayer** out_layer)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_layer, "out_layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_network_add_reverse_sequence(
    JYPPX_TensorRtNetworkDefinition* network,
    JYPPX_TensorRtTensor* input_tensor,
...
JYPPX_StatusCode jyppx_trt8_fill_layer_set_dimensions(JYPPX_TensorRtLayer* layer, const JYPPX_TensorRtDims* dimensions)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_fill_layer_get_dimensions(JYPPX_TensorRtLayer* layer, JYPPX_TensorRtDims* out_dimensions)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_dimensions, "out_dimensions");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_fill_layer_set_operation(JYPPX_TensorRtLayer* layer, int32_t operation)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_fill_layer_get_operation(JYPPX_TensorRtLayer* layer, int32_t* out_operation)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_operation, "out_operation");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_fill_layer_set_alpha(JYPPX_TensorRtLayer* layer, double alpha)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_fill_layer_get_alpha(JYPPX_TensorRtLayer* layer, double* out_alpha)
{
...
JYPPX_StatusCode jyppx_trt8_fill_layer_set_beta(JYPPX_TensorRtLayer* layer, double beta)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_fill_layer_get_beta(JYPPX_TensorRtLayer* layer, double* out_beta)
{
...
JYPPX_StatusCode jyppx_trt8_reverse_sequence_layer_set_batch_axis(JYPPX_TensorRtLayer* layer, int32_t axis)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_reverse_sequence_layer_get_batch_axis(JYPPX_TensorRtLayer* layer, int32_t* out_axis)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_axis, "out_axis");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_reverse_sequence_layer_set_sequence_axis(JYPPX_TensorRtLayer* layer, int32_t axis)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_reverse_sequence_layer_get_sequence_axis(JYPPX_TensorRtLayer* layer, int32_t* out_axis)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_axis, "out_axis");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_get_output(JYPPX_TensorRtLayer* layer, int32_t index, JYPPX_TensorRtTensor** out_tensor)
{
...
JYPPX_StatusCode jyppx_trt8_layer_get_input(JYPPX_TensorRtLayer* layer, int32_t index, JYPPX_TensorRtTensor** out_tensor)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_tensor, "out_tensor");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_get_input_count(JYPPX_TensorRtLayer* layer, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_get_output_count(JYPPX_TensorRtLayer* layer, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_get_type(JYPPX_TensorRtLayer* layer, int32_t* out_type)
{
...
JYPPX_StatusCode jyppx_trt8_layer_get_name(JYPPX_TensorRtLayer* layer, char* output_buffer, size_t output_buffer_size, size_t* out_required_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_required_size, "out_required_size");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_set_name(JYPPX_TensorRtLayer* layer, const char* name)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_get_metadata(JYPPX_TensorRtLayer* layer, char* output_buffer, size_t output_buffer_size, size_t* out_required_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_required_size, "out_required_size");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_set_metadata(JYPPX_TensorRtLayer* layer, const char* metadata)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_set_precision(JYPPX_TensorRtLayer* layer, int32_t data_type)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_get_precision(JYPPX_TensorRtLayer* layer, int32_t* out_data_type)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_data_type, "out_data_type");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_precision_is_set(JYPPX_TensorRtLayer* layer, JYPPX_Boolean* out_is_set)
{
...
JYPPX_StatusCode jyppx_trt8_layer_reset_precision(JYPPX_TensorRtLayer* layer)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_set_output_type(JYPPX_TensorRtLayer* layer, int32_t index, int32_t data_type)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_get_output_type(JYPPX_TensorRtLayer* layer, int32_t index, int32_t* out_data_type)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_data_type, "out_data_type");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_output_type_is_set(JYPPX_TensorRtLayer* layer, int32_t index, JYPPX_Boolean* out_is_set)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_is_set, "out_is_set");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_layer_reset_output_type(JYPPX_TensorRtLayer* layer, int32_t index)
{
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_get_name(JYPPX_TensorRtTensor* tensor, char* output_buffer, size_t output_buffer_size, size_t* out_required_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_required_size, "out_required_size");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_set_name(JYPPX_TensorRtTensor* tensor, const char* name)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_get_data_type(JYPPX_TensorRtTensor* tensor, int32_t* out_data_type)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_data_type, "out_data_type");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_set_data_type(JYPPX_TensorRtTensor* tensor, int32_t data_type)
{
    auto status = jyppx::tensorrt::validate_handle(tensor, kLine, JYPPX_TENSORRT_OBJECT_KIND_TENSOR, "tensor");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_get_shape(JYPPX_TensorRtTensor* tensor, JYPPX_TensorRtDims* out_dims)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_dims, "out_dims");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_set_shape(JYPPX_TensorRtTensor* tensor, const JYPPX_TensorRtDims* dims)
{
    auto status = jyppx::tensorrt::validate_handle(tensor, kLine, JYPPX_TENSORRT_OBJECT_KIND_TENSOR, "tensor");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_get_dimensions(JYPPX_TensorRtTensor* tensor, JYPPX_TensorRtDims* out_dims)
{
    return jyppx_trt8_tensor_get_shape(tensor, out_dims);
}

JYPPX_StatusCode jyppx_trt8_tensor_set_dimensions(JYPPX_TensorRtTensor* tensor, const JYPPX_TensorRtDims* dims)
{
    return jyppx_trt8_tensor_set_shape(tensor, dims);
}

JYPPX_StatusCode jyppx_trt8_tensor_get_location(JYPPX_TensorRtTensor* tensor, int32_t* out_location)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_set_location(JYPPX_TensorRtTensor* tensor, int32_t location)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_get_allowed_formats(JYPPX_TensorRtTensor* tensor, uint32_t* out_formats)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_set_allowed_formats(JYPPX_TensorRtTensor* tensor, uint32_t formats)
{
    if (formats == 0)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_set_dynamic_range(JYPPX_TensorRtTensor* tensor, float min, float max)
{
    if (min > max)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_dynamic_range_is_set(JYPPX_TensorRtTensor* tensor, JYPPX_Boolean* out_is_set)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_is_set, "out_is_set");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_get_dynamic_range_min(JYPPX_TensorRtTensor* tensor, float* out_min)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_get_dynamic_range_max(JYPPX_TensorRtTensor* tensor, float* out_max)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_reset_dynamic_range(JYPPX_TensorRtTensor* tensor)
{
    auto status = jyppx::tensorrt::validate_handle(tensor, kLine, JYPPX_TENSORRT_OBJECT_KIND_TENSOR, "tensor");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_get_broadcast_across_batch(JYPPX_TensorRtTensor* tensor, JYPPX_Boolean* out_broadcast_across_batch)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_set_broadcast_across_batch(JYPPX_TensorRtTensor* tensor, JYPPX_Boolean broadcast_across_batch)
{
    auto status = jyppx::tensorrt::validate_handle(tensor, kLine, JYPPX_TENSORRT_OBJECT_KIND_TENSOR, "tensor");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_is_network_input(JYPPX_TensorRtTensor* tensor, JYPPX_Boolean* out_is_network_input)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_is_network_output(JYPPX_TensorRtTensor* tensor, JYPPX_Boolean* out_is_network_output)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_is_shape_tensor(JYPPX_TensorRtTensor* tensor, JYPPX_Boolean* out_is_shape_tensor)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_is_execution_tensor(JYPPX_TensorRtTensor* tensor, JYPPX_Boolean* out_is_execution_tensor)
{
...
JYPPX_StatusCode jyppx_trt8_tensor_get_dimension_name(JYPPX_TensorRtTensor* tensor, int32_t dimension_index, char* output_buffer, size_t output_buffer_size, size_t* out_required_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_required_size, "out_required_size");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_tensor_set_dimension_name(JYPPX_TensorRtTensor* tensor, int32_t dimension_index, const char* name)
{
    if (dimension_index < 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Tensor dimension index must be greater than or equal to zero.");
...
JYPPX_StatusCode jyppx_trt8_tensor_clear_dimension_name(JYPPX_TensorRtTensor* tensor, int32_t dimension_index)
{
    if (dimension_index < 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Tensor dimension index must be greater than or equal to zero.");
...
JYPPX_StatusCode jyppx_trt8_engine_get_layer_count(JYPPX_TensorRtCudaEngine* engine, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_engine_is_refittable(JYPPX_TensorRtCudaEngine* engine, JYPPX_Boolean* out_refittable)
{
...
JYPPX_StatusCode jyppx_trt8_engine_create_refitter(JYPPX_TensorRtCudaEngine* engine, JYPPX_TensorRtLogger* logger, JYPPX_TensorRtRefitter** out_refitter)
{
...
JYPPX_StatusCode jyppx_trt8_refitter_get_missing_count(JYPPX_TensorRtRefitter* refitter, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_refitter_get_all_count(JYPPX_TensorRtRefitter* refitter, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_refitter_get_missing_entries(JYPPX_TensorRtRefitter* refitter, JYPPX_TensorRtRefitEntryInfo* output_entries, int32_t output_count, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_refitter_get_all_entries(JYPPX_TensorRtRefitter* refitter, JYPPX_TensorRtRefitEntryInfo* output_entries, int32_t output_count, int32_t* out_count)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_count, "out_count");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_refitter_set_weights(JYPPX_TensorRtRefitter* refitter, const char* layer_name, int32_t role, int32_t data_type, const void* values, int64_t value_count, JYPPX_Boolean* out_set)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_set, "out_set");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_refitter_refit_cuda_engine(JYPPX_TensorRtRefitter* refitter, JYPPX_Boolean* out_refitted)
{
...
#define JYPPX_TRT_REFITTER_API(name) jyppx_trt8_##name
#include "../common/refitter_controls.inc"

JYPPX_StatusCode jyppx_trt8_engine_get_name(JYPPX_TensorRtCudaEngine* engine, char* output_buffer, size_t output_buffer_size, size_t* out_required_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_required_size, "out_required_size");
    if (status != JYPPX_STATUS_OK)
    {
...
#define JYPPX_TRT8_ENGINE_TENSOR_INT_QUERY(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME, EXPR) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_ENGINE_TENSOR_INT_QUERY(jyppx_trt8_engine_get_tensor_location, out_location, "engine tensor location query", engine_payload->getTensorLocation(tensor_name))
JYPPX_TRT8_ENGINE_TENSOR_INT_QUERY(jyppx_trt8_engine_get_tensor_bytes_per_component, out_bytes, "engine tensor bytes-per-component query", engine_payload->getTensorBytesPerComponent(tensor_name))
JYPPX_TRT8_ENGINE_TENSOR_INT_QUERY(jyppx_trt8_engine_get_tensor_components_per_element, out_components, "engine tensor components-per-element query", engine_payload->getTensorComponentsPerElement(tensor_name))
JYPPX_TRT8_ENGINE_TENSOR_INT_QUERY(jyppx_trt8_engine_get_tensor_format, out_format, "engine tensor format query", engine_payload->getTensorFormat(tensor_name))
JYPPX_TRT8_ENGINE_TENSOR_INT_QUERY(jyppx_trt8_engine_get_tensor_vectorized_dim, out_dim, "engine tensor vectorized dimension query", engine_payload->getTensorVectorizedDim(tensor_name))
#else
#define JYPPX_TRT8_ENGINE_TENSOR_INT_MISSING(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME) \
...
JYPPX_TRT8_ENGINE_TENSOR_INT_MISSING(jyppx_trt8_engine_get_tensor_location, out_location, "engine tensor location query")
JYPPX_TRT8_ENGINE_TENSOR_INT_MISSING(jyppx_trt8_engine_get_tensor_bytes_per_component, out_bytes, "engine tensor bytes-per-component query")
JYPPX_TRT8_ENGINE_TENSOR_INT_MISSING(jyppx_trt8_engine_get_tensor_components_per_element, out_components, "engine tensor components-per-element query")
JYPPX_TRT8_ENGINE_TENSOR_INT_MISSING(jyppx_trt8_engine_get_tensor_format, out_format, "engine tensor format query")
JYPPX_TRT8_ENGINE_TENSOR_INT_MISSING(jyppx_trt8_engine_get_tensor_vectorized_dim, out_dim, "engine tensor vectorized dimension query")
#undef JYPPX_TRT8_ENGINE_TENSOR_INT_MISSING
#endif

#undef JYPPX_TRT8_ENGINE_TENSOR_INT_QUERY

JYPPX_StatusCode jyppx_trt8_engine_get_tensor_format_desc(
    JYPPX_TensorRtCudaEngine* engine,
...
JYPPX_StatusCode jyppx_trt8_engine_is_shape_inference_io(JYPPX_TensorRtCudaEngine* engine, const char* tensor_name, JYPPX_Boolean* out_is_shape_inference_io)
{
...
#define JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_QUERY(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME, EXPR) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_QUERY(jyppx_trt8_engine_get_tensor_bytes_per_component_for_profile, out_bytes, "engine tensor profile bytes-per-component query", engine_payload->getTensorBytesPerComponent(tensor_name, profile_index))
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_QUERY(jyppx_trt8_engine_get_tensor_components_per_element_for_profile, out_components, "engine tensor profile components-per-element query", engine_payload->getTensorComponentsPerElement(tensor_name, profile_index))
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_QUERY(jyppx_trt8_engine_get_tensor_format_for_profile, out_format, "engine tensor profile format query", engine_payload->getTensorFormat(tensor_name, profile_index))
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_QUERY(jyppx_trt8_engine_get_tensor_vectorized_dim_for_profile, out_dim, "engine tensor profile vectorized dimension query", engine_payload->getTensorVectorizedDim(tensor_name, profile_index))
#else
#define JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_MISSING(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME) \
...
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_MISSING(jyppx_trt8_engine_get_tensor_bytes_per_component_for_profile, out_bytes, "engine tensor profile bytes-per-component query")
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_MISSING(jyppx_trt8_engine_get_tensor_components_per_element_for_profile, out_components, "engine tensor profile components-per-element query")
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_MISSING(jyppx_trt8_engine_get_tensor_format_for_profile, out_format, "engine tensor profile format query")
JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_MISSING(jyppx_trt8_engine_get_tensor_vectorized_dim_for_profile, out_dim, "engine tensor profile vectorized dimension query")
#undef JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_MISSING
#endif
#undef JYPPX_TRT8_ENGINE_TENSOR_PROFILE_INT_QUERY

JYPPX_StatusCode jyppx_trt8_engine_get_tensor_format_desc_for_profile(
    JYPPX_TensorRtCudaEngine* engine,
    const char* tensor_name,
...
JYPPX_StatusCode jyppx_trt8_engine_get_profile_shape(
    JYPPX_TensorRtCudaEngine* engine,
    const char* tensor_name,
    int32_t profile_index,
    int32_t selector,
...
JYPPX_StatusCode jyppx_trt8_cuda_engine_get_profile_shape_values(
    JYPPX_TensorRtCudaEngine* engine,
    ...
    int32_t* out_count)
{
    ...
    *out_count = 0;
    ...
    if (output_count < 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Output count must be greater than or equal to zero.");
        return JYPPX_STATUS_INVALID_ARGUMENT;
    }

    if (output_values == nullptr && output_count > 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Output values buffer must not be null when output_count is greater than zero.");
        return JYPPX_STATUS_INVALID_ARGUMENT;
    }

#if JYPPX_HAS_TENSORRT && JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    nvinfer1::ICudaEngine* engine_payload = nullptr;
    status = get_engine_payload_ext(engine, &engine_payload, "engine profile shape values query");
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }

    const int32_t* values = engine_payload->getProfileShapeValues(profile_index, binding_index, static_cast<nvinfer1::OptProfileSelector>(selector));
    if (values == nullptr)
    {
        *out_count = 0;
        return JYPPX_STATUS_OK;
    ...
    const nvinfer1::Dims binding_dims = engine_payload->getBindingDimensions(binding_index);
    int32_t value_count = 0;
    if (binding_dims.nbDims > 0)
    {
        value_count = 1;
        for (int32_t i = 0; i < binding_dims.nbDims; ++i)
        {
            const int32_t extent = static_cast<int32_t>(binding_dims.d[i]);
            if (extent <= 0)
            {
                value_count = 0;
                break;
    ...
    *out_count = value_count;
    ...
    const int32_t copy_count = output_count < value_count ? output_count : value_count;
    for (int32_t i = 0; i < copy_count; ++i)
    {
        output_values[i] = values[i];
    }

    return copy_count == value_count ? JYPPX_STATUS_OK : JYPPX_STATUS_BUFFER_TOO_SMALL;
#elif JYPPX_HAS_TENSORRT
    (void)engine;
    (void)binding_index;
    (void)profile_index;
    ...
    (void)output_values;
    (void)output_count;
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "engine profile shape values query");
#else
    (void)engine;
    (void)binding_index;
    (void)profile_index;
    ...
    (void)output_values;
    (void)output_count;
    return jyppx::tensorrt::report_vendor_missing(kLine, "engine profile shape values query");
#endif
}

JYPPX_StatusCode jyppx_trt8_engine_get_engine_capability(JYPPX_TensorRtCudaEngine* engine, int32_t* out_capability)
{
...
JYPPX_StatusCode jyppx_trt8_engine_get_tactic_sources(JYPPX_TensorRtCudaEngine* engine, uint32_t* out_tactic_sources)
{
...
JYPPX_StatusCode jyppx_trt8_engine_get_profiling_verbosity(JYPPX_TensorRtCudaEngine* engine, int32_t* out_verbosity)
{
...
JYPPX_StatusCode jyppx_trt8_engine_get_hardware_compatibility_level(JYPPX_TensorRtCudaEngine* engine, int32_t* out_level)
{
...
#elif JYPPX_HAS_TENSORRT
    (void)engine;
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "engine hardware compatibility level query");
#else
    (void)engine;
...
JYPPX_StatusCode jyppx_trt8_engine_get_max_batch_size(JYPPX_TensorRtCudaEngine* engine, int32_t* out_max_batch_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_max_batch_size, "out_max_batch_size");
    if (status != JYPPX_STATUS_OK)
    {
...
#if JYPPX_HAS_TENSORRT && JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    nvinfer1::ICudaEngine* engine_payload = nullptr;
    status = get_engine_payload_ext(engine, &engine_payload, "engine max batch size query");
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }

    *out_max_batch_size = engine_payload->getMaxBatchSize();
    return JYPPX_STATUS_OK;
#elif JYPPX_HAS_TENSORRT
    (void)engine;
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "engine max batch size query");
#else
    (void)engine;
    return jyppx::tensorrt::report_vendor_missing(kLine, "engine max batch size query");
#endif
}

#define JYPPX_TRT8_CONTEXT_DIMS_QUERY(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME, EXPR) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_CONTEXT_DIMS_QUERY(jyppx_trt8_execution_context_get_tensor_shape, out_shape, "execution context tensor shape query", context_payload->getTensorShape(tensor_name))
JYPPX_TRT8_CONTEXT_DIMS_QUERY(jyppx_trt8_execution_context_get_tensor_strides, out_strides, "execution context tensor strides query", context_payload->getTensorStrides(tensor_name))
#else
#define JYPPX_TRT8_CONTEXT_DIMS_MISSING(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME) \
...
JYPPX_TRT8_CONTEXT_DIMS_MISSING(jyppx_trt8_execution_context_get_tensor_shape, out_shape, "execution context tensor shape query")
JYPPX_TRT8_CONTEXT_DIMS_MISSING(jyppx_trt8_execution_context_get_tensor_strides, out_strides, "execution context tensor strides query")
#undef JYPPX_TRT8_CONTEXT_DIMS_MISSING
#endif
#undef JYPPX_TRT8_CONTEXT_DIMS_QUERY

JYPPX_StatusCode jyppx_trt8_execution_context_is_tensor_address_bound(JYPPX_TensorRtExecutionContext* context, const char* tensor_name, JYPPX_Boolean* out_bound)
{
...
JYPPX_StatusCode jyppx_trt8_execution_context_set_debug_sync(JYPPX_TensorRtExecutionContext* context, JYPPX_Boolean debug_sync)
{
#if JYPPX_HAS_TENSORRT
    nvinfer1::IExecutionContext* context_payload = nullptr;
...
JYPPX_StatusCode jyppx_trt8_execution_context_get_debug_sync(JYPPX_TensorRtExecutionContext* context, JYPPX_Boolean* out_debug_sync)
{
...
JYPPX_StatusCode jyppx_trt8_execution_context_set_nvtx_verbosity(JYPPX_TensorRtExecutionContext* context, int32_t verbosity, JYPPX_Boolean* out_set)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_set, "out_set");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_execution_context_get_nvtx_verbosity(JYPPX_TensorRtExecutionContext* context, int32_t* out_verbosity)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_verbosity, "out_verbosity");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_execution_context_set_name(JYPPX_TensorRtExecutionContext* context, const char* name)
{
...
JYPPX_StatusCode jyppx_trt8_execution_context_get_name(JYPPX_TensorRtExecutionContext* context, char* output_buffer, size_t output_buffer_size, size_t* out_required_size)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_required_size, "out_required_size");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_execution_context_set_optimization_profile_async(JYPPX_TensorRtExecutionContext* context, int32_t profile_index, JYPPX_CudaStream* stream)
{
    if (profile_index < 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Profile index must be greater than or equal to zero.");
...
#define JYPPX_TRT8_CONTEXT_BOOL_QUERY(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME, EXPR) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_CONTEXT_BOOL_QUERY(jyppx_trt8_execution_context_all_input_dimensions_specified, out_specified, "execution context input dimensions specified query", context_payload->allInputDimensionsSpecified())
JYPPX_TRT8_CONTEXT_BOOL_QUERY(jyppx_trt8_execution_context_all_input_shapes_specified, out_specified, "execution context input shapes specified query", context_payload->allInputShapesSpecified())
JYPPX_TRT8_CONTEXT_BOOL_QUERY(jyppx_trt8_execution_context_get_enqueue_emits_profile, out_enqueue_emits_profile, "execution context enqueue emits profile query", context_payload->getEnqueueEmitsProfile())
#else
#define JYPPX_TRT8_CONTEXT_BOOL_MISSING(FUNCTION_NAME, OUTPUT_NAME, FEATURE_NAME) \
...
JYPPX_TRT8_CONTEXT_BOOL_MISSING(jyppx_trt8_execution_context_all_input_dimensions_specified, out_specified, "execution context input dimensions specified query")
JYPPX_TRT8_CONTEXT_BOOL_MISSING(jyppx_trt8_execution_context_all_input_shapes_specified, out_specified, "execution context input shapes specified query")
JYPPX_TRT8_CONTEXT_BOOL_MISSING(jyppx_trt8_execution_context_get_enqueue_emits_profile, out_enqueue_emits_profile, "execution context enqueue emits profile query")
#undef JYPPX_TRT8_CONTEXT_BOOL_MISSING
#endif
#undef JYPPX_TRT8_CONTEXT_BOOL_QUERY

JYPPX_StatusCode jyppx_trt8_execution_context_infer_shapes(JYPPX_TensorRtExecutionContext* context, int32_t* out_missing_count)
{
...
JYPPX_StatusCode jyppx_trt8_execution_context_set_enqueue_emits_profile(JYPPX_TensorRtExecutionContext* context, JYPPX_Boolean enqueue_emits_profile)
{
#if JYPPX_HAS_TENSORRT
    nvinfer1::IExecutionContext* context_payload = nullptr;
...
JYPPX_StatusCode jyppx_trt8_execution_context_set_profiler(JYPPX_TensorRtExecutionContext* context, JYPPX_TensorRtProfiler* profiler)
{
#if JYPPX_HAS_TENSORRT
    if (JYPPX_TENSORRT_VERSION_MAJOR_NUM != 8)
    {
...
JYPPX_StatusCode jyppx_trt8_execution_context_clear_profiler(JYPPX_TensorRtExecutionContext* context)
{
#if JYPPX_HAS_TENSORRT
    if (JYPPX_TENSORRT_VERSION_MAJOR_NUM != 8)
    {
...
JYPPX_StatusCode jyppx_trt8_execution_context_has_profiler(JYPPX_TensorRtExecutionContext* context, JYPPX_Boolean* out_has_profiler)
{
...
JYPPX_StatusCode jyppx_trt8_execution_context_report_to_profiler(JYPPX_TensorRtExecutionContext* context, JYPPX_Boolean* out_reported)
{
...
JYPPX_StatusCode jyppx_trt8_reduce_layer_set_operation(JYPPX_TensorRtLayer* layer, int32_t operation)
{
    if (operation < 0 || operation > 4)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Reduce operation must be in the TensorRT enum range [0, 4].");
...
JYPPX_StatusCode jyppx_trt8_reduce_layer_set_axes(JYPPX_TensorRtLayer* layer, uint32_t axes)
{
    if (axes == 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Reduce axes bitmask must not be zero.");
...
JYPPX_StatusCode jyppx_trt8_reduce_layer_set_keep_dimensions(JYPPX_TensorRtLayer* layer, JYPPX_Boolean keep_dimensions)
{
#if JYPPX_HAS_TENSORRT
    LayerReferencePayload* payload = nullptr;
    auto status = get_layer_reference_ext(layer, &payload, "reduce");
...
JYPPX_StatusCode jyppx_trt8_unary_layer_set_operation(JYPPX_TensorRtLayer* layer, int32_t operation)
{
    if (operation < 0 || operation > 24)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Unary operation must be in the TensorRT enum range [0, 24].");
...
JYPPX_StatusCode jyppx_trt8_topk_layer_set_operation(JYPPX_TensorRtLayer* layer, int32_t operation)
{
    if (operation < 0 || operation > 1)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TopK operation must be in the TensorRT enum range [0, 1].");
...
JYPPX_StatusCode jyppx_trt8_topk_layer_set_k(JYPPX_TensorRtLayer* layer, int32_t k)
{
    if (k <= 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TopK k must be greater than zero.");
...
JYPPX_StatusCode jyppx_trt8_topk_layer_set_axes(JYPPX_TensorRtLayer* layer, uint32_t axes)
{
    if (axes == 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "TopK axes bitmask must not be zero.");
...
JYPPX_StatusCode jyppx_trt8_gather_layer_set_axis(JYPPX_TensorRtLayer* layer, int32_t axis)
{
    if (axis < 0)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Gather axis must be greater than or equal to zero.");
...
JYPPX_StatusCode jyppx_trt8_elementwise_layer_get_operation(JYPPX_TensorRtLayer* layer, int32_t* out_operation)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_operation, "out_operation");
    if (status != JYPPX_STATUS_OK)
    {
...
JYPPX_StatusCode jyppx_trt8_elementwise_layer_set_operation(JYPPX_TensorRtLayer* layer, int32_t operation)
{
    if (operation < 0 || operation > 13)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "ElementWise operation must be in the TensorRT enum range [0, 13].");
...
JYPPX_StatusCode jyppx_trt8_activation_layer_set_type(JYPPX_TensorRtLayer* layer, int32_t activation_type)
{
...
#define JYPPX_TRT8_ACTIVATION_DOUBLE_ACCESSOR(FUNCTION_GET, FUNCTION_SET, GETTER, SETTER, OUTPUT_NAME, FIELD_NAME) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_ACTIVATION_DOUBLE_ACCESSOR(jyppx_trt8_activation_layer_get_alpha, jyppx_trt8_activation_layer_set_alpha, getAlpha, setAlpha, out_alpha, alpha)
JYPPX_TRT8_ACTIVATION_DOUBLE_ACCESSOR(jyppx_trt8_activation_layer_get_beta, jyppx_trt8_activation_layer_set_beta, getBeta, setBeta, out_beta, beta)
#else
JYPPX_StatusCode jyppx_trt8_activation_layer_get_alpha(JYPPX_TensorRtLayer*, double* out_alpha)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_alpha, "out_alpha");
    if (status != JYPPX_STATUS_OK) { return status; }
    *out_alpha = 0.0;
...
JYPPX_StatusCode jyppx_trt8_activation_layer_set_alpha(JYPPX_TensorRtLayer*, double)
{
    return jyppx::tensorrt::report_vendor_missing(kLine, "activation layer alpha set");
}
JYPPX_StatusCode jyppx_trt8_activation_layer_get_beta(JYPPX_TensorRtLayer*, double* out_beta)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_beta, "out_beta");
    if (status != JYPPX_STATUS_OK) { return status; }
    *out_beta = 0.0;
...
JYPPX_StatusCode jyppx_trt8_activation_layer_set_beta(JYPPX_TensorRtLayer*, double)
{
    return jyppx::tensorrt::report_vendor_missing(kLine, "activation layer beta set");
}
#endif
#undef JYPPX_TRT8_ACTIVATION_DOUBLE_ACCESSOR

JYPPX_StatusCode jyppx_trt8_pooling_layer_set_type(JYPPX_TensorRtLayer* layer, int32_t pooling_type)
{
    if (pooling_type < 0 || pooling_type > 2)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Pooling type must be between 0 and 2.");
...
#define JYPPX_TRT8_POOLING_DOUBLE_ACCESSOR(FUNCTION_GET, FUNCTION_SET, GETTER, SETTER, OUTPUT_NAME, FIELD_NAME, FEATURE) \
    JYPPX_StatusCode FUNCTION_GET(JYPPX_TensorRtLayer* layer, double* OUTPUT_NAME) \
    { \
        auto status = jyppx::tensorrt::validate_output_pointer(OUTPUT_NAME, #OUTPUT_NAME); \
        if (status != JYPPX_STATUS_OK) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_POOLING_DOUBLE_ACCESSOR(jyppx_trt8_pooling_layer_get_blend_factor, jyppx_trt8_pooling_layer_set_blend_factor, getBlendFactor, setBlendFactor, out_blend_factor, blend_factor, "pooling blend factor")
#else
JYPPX_StatusCode jyppx_trt8_pooling_layer_get_blend_factor(JYPPX_TensorRtLayer*, double* out_blend_factor)
{
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_blend_factor(JYPPX_TensorRtLayer*, double)
{
    return jyppx::tensorrt::report_vendor_missing(kLine, "pooling layer blend factor set");
}
#endif
#undef JYPPX_TRT8_POOLING_DOUBLE_ACCESSOR

JYPPX_StatusCode jyppx_trt8_pooling_layer_get_average_count_excludes_padding(JYPPX_TensorRtLayer* layer, JYPPX_Boolean* out_excludes_padding)
{
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_average_count_excludes_padding(JYPPX_TensorRtLayer* layer, JYPPX_Boolean excludes_padding)
{
#if JYPPX_HAS_TENSORRT
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
...
#define JYPPX_TRT8_POOLING_DIMS_ACCESSOR(FUNCTION_GET, FUNCTION_SET, GETTER, SETTER, OUTPUT_NAME, INPUT_NAME, FEATURE) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_POOLING_DIMS_ACCESSOR(jyppx_trt8_pooling_layer_get_pre_padding, jyppx_trt8_pooling_layer_set_pre_padding, getPrePadding, setPrePadding, out_pre_padding, pre_padding, "pooling pre-padding")
JYPPX_TRT8_POOLING_DIMS_ACCESSOR(jyppx_trt8_pooling_layer_get_post_padding, jyppx_trt8_pooling_layer_set_post_padding, getPostPadding, setPostPadding, out_post_padding, post_padding, "pooling post-padding")
#else
JYPPX_StatusCode jyppx_trt8_pooling_layer_get_pre_padding(JYPPX_TensorRtLayer*, JYPPX_TensorRtDims* out_pre_padding)
{
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_pre_padding(JYPPX_TensorRtLayer*, const JYPPX_TensorRtDims*)
{
    return jyppx::tensorrt::report_vendor_missing(kLine, "pooling layer pre-padding set");
}
JYPPX_StatusCode jyppx_trt8_pooling_layer_get_post_padding(JYPPX_TensorRtLayer*, JYPPX_TensorRtDims* out_post_padding)
{
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_post_padding(JYPPX_TensorRtLayer*, const JYPPX_TensorRtDims*)
{
    return jyppx::tensorrt::report_vendor_missing(kLine, "pooling layer post-padding set");
}
#endif
#undef JYPPX_TRT8_POOLING_DIMS_ACCESSOR

JYPPX_StatusCode jyppx_trt8_pooling_layer_get_padding_mode(JYPPX_TensorRtLayer* layer, int32_t* out_padding_mode)
{
...
JYPPX_StatusCode jyppx_trt8_pooling_layer_set_padding_mode(JYPPX_TensorRtLayer* layer, int32_t padding_mode)
{
...
#define JYPPX_TRT8_RESIZE_ENUM_ACCESSOR(FUNCTION_GET, FUNCTION_SET, GETTER, SETTER, OUTPUT_NAME, INPUT_NAME, MIN_VALUE, MAX_VALUE, ENUM_TYPE, FEATURE) \
...
#if JYPPX_HAS_TENSORRT
JYPPX_TRT8_RESIZE_ENUM_ACCESSOR(jyppx_trt8_resize_layer_get_coordinate_transformation, jyppx_trt8_resize_layer_set_coordinate_transformation, getCoordinateTransformation, setCoordinateTransformation, out_coordinate_transformation, coordinate_transformation, 0, 2, nvinfer1::ResizeCoordinateTransformation, "Resize coordinate transformation")
JYPPX_TRT8_RESIZE_ENUM_ACCESSOR(jyppx_trt8_resize_layer_get_selector_for_single_pixel, jyppx_trt8_resize_layer_set_selector_for_single_pixel, getSelectorForSinglePixel, setSelectorForSinglePixel, out_selector, selector, 0, 1, nvinfer1::ResizeSelector, "Resize selector")
JYPPX_TRT8_RESIZE_ENUM_ACCESSOR(jyppx_trt8_resize_layer_get_nearest_rounding, jyppx_trt8_resize_layer_set_nearest_rounding, getNearestRounding, setNearestRounding, out_rounding, rounding, 0, 3, nvinfer1::ResizeRoundMode, "Resize nearest rounding")
#else
#define JYPPX_TRT8_RESIZE_ENUM_MISSING(FUNCTION_GET, FUNCTION_SET, OUTPUT_NAME, INPUT_NAME, FEATURE) \
...
JYPPX_TRT8_RESIZE_ENUM_MISSING(jyppx_trt8_resize_layer_get_coordinate_transformation, jyppx_trt8_resize_layer_set_coordinate_transformation, out_coordinate_transformation, coordinate_transformation, "resize coordinate transformation")
JYPPX_TRT8_RESIZE_ENUM_MISSING(jyppx_trt8_resize_layer_get_selector_for_single_pixel, jyppx_trt8_resize_layer_set_selector_for_single_pixel, out_selector, selector, "resize selector")
JYPPX_TRT8_RESIZE_ENUM_MISSING(jyppx_trt8_resize_layer_get_nearest_rounding, jyppx_trt8_resize_layer_set_nearest_rounding, out_rounding, rounding, "resize nearest rounding")
#undef JYPPX_TRT8_RESIZE_ENUM_MISSING
#endif
#undef JYPPX_TRT8_RESIZE_ENUM_ACCESSOR

JYPPX_StatusCode jyppx_trt8_resize_layer_get_cubic_coeff(JYPPX_TensorRtLayer* layer, double* out_cubic_coeff)
{
...
JYPPX_StatusCode jyppx_trt8_resize_layer_set_cubic_coeff(JYPPX_TensorRtLayer* layer, double cubic_coeff)
{
#if JYPPX_HAS_TENSORRT
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
...
JYPPX_StatusCode jyppx_trt8_resize_layer_get_exclude_outside(JYPPX_TensorRtLayer* layer, JYPPX_Boolean* out_exclude_outside)
{
...
JYPPX_StatusCode jyppx_trt8_resize_layer_set_exclude_outside(JYPPX_TensorRtLayer* layer, JYPPX_Boolean exclude_outside)
{
#if JYPPX_HAS_TENSORRT
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
...
JYPPX_StatusCode jyppx_trt8_resize_layer_get_align_corners(JYPPX_TensorRtLayer* layer, JYPPX_Boolean* out_align_corners)
{
    auto status = jyppx::tensorrt::validate_output_pointer(out_align_corners, "out_align_corners");
    if (status != JYPPX_STATUS_OK)
    {
        return status;
    }

    *out_align_corners = JYPPX_FALSE;
#if JYPPX_HAS_TENSORRT && JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    {
    ...
    *out_align_corners = resize_layer->getAlignCorners() ? JYPPX_TRUE : JYPPX_FALSE;
    return JYPPX_STATUS_OK;
#elif JYPPX_HAS_TENSORRT
    (void)layer;
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "resize layer align-corners query");
#else
    (void)layer;
    return jyppx::tensorrt::report_vendor_missing(kLine, "resize layer align-corners query");
#endif
}

JYPPX_StatusCode jyppx_trt8_resize_layer_set_align_corners(JYPPX_TensorRtLayer* layer, JYPPX_Boolean align_corners)
{
#if JYPPX_HAS_TENSORRT && JYPPX_TENSORRT_VERSION_MAJOR_NUM == 8
    auto status = jyppx::tensorrt::validate_handle(layer, kLine, JYPPX_TENSORRT_OBJECT_KIND_LAYER, "layer");
    if (status != JYPPX_STATUS_OK)
    ...
    resize_layer->setAlignCorners(align_corners != JYPPX_FALSE);
    return JYPPX_STATUS_OK;
#elif JYPPX_HAS_TENSORRT
    (void)layer;
    (void)align_corners;
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "resize layer align-corners set");
#else
    (void)layer;
    (void)align_corners;
    return jyppx::tensorrt::report_vendor_missing(kLine, "resize layer align-corners set");
#endif
}

JYPPX_StatusCode jyppx_trt8_resize_layer_get_resize_mode(JYPPX_TensorRtLayer* layer, int32_t* out_mode)
{
    return jyppx_trt8_resize_layer_get_mode(layer, out_mode);
}

JYPPX_StatusCode jyppx_trt8_resize_layer_set_resize_mode(JYPPX_TensorRtLayer* layer, int32_t mode)
{
    return jyppx_trt8_resize_layer_set_mode(layer, mode);
}

#define JYPPX_TRT_RUNTIME_API(name) jyppx_trt8_##name
#include "../common/runtime_controls.inc"
#undef JYPPX_TRT_RUNTIME_API

#define JYPPX_TRT_BUILDER_CALLBACK_BOUNDARY_API(name) jyppx_trt8_##name
#include "../common/builder_callback_boundary_controls.inc"
#undef JYPPX_TRT_BUILDER_CALLBACK_BOUNDARY_API

#define JYPPX_TRT_ERROR_RECORDER_BOUNDARY_API(name) jyppx_trt8_##name
#include "../common/error_recorder_boundary_controls.inc"
#undef JYPPX_TRT_ERROR_RECORDER_BOUNDARY_API

#define JYPPX_TRT_EXECUTION_CONTEXT_ALLOCATOR_API(name) jyppx_trt8_##name
#include "../common/execution_context_allocator_controls.inc"
#undef JYPPX_TRT_EXECUTION_CONTEXT_ALLOCATOR_API

#define JYPPX_TRT_EXECUTION_CONTEXT_CALLBACK_STATE_API(name) jyppx_trt8_##name
#include "../common/execution_context_callback_state_snapshot.inc"
#undef JYPPX_TRT_EXECUTION_CONTEXT_CALLBACK_STATE_API

#define JYPPX_TRT_ALLOCATOR_OWNER_DRY_RUN_API(name) jyppx_trt8_##name
#include "../common/allocator_owner_dry_run.inc"
#undef JYPPX_TRT_ALLOCATOR_OWNER_DRY_RUN_API

#define JYPPX_TRT_ONNX_CONFIG_API(name) jyppx_trt8_onnx_config_##name
#define JYPPX_TRT_EXPECTED_MAJOR 8
...
#include "modules/layers/scatter_layer_compat.inc"
#include "modules/layers/cross_version_ninth_network_layer.inc"
#include "modules/layers/rnn_v2_readonly.inc"

#include "modules/context/deployment_context.inc"

JYPPX_StatusCode jyppx_trt8_execution_context_get_shape_binding(
    JYPPX_TensorRtExecutionContext* context,
    int32_t binding_index,
    int32_t* output_values,
    int32_t output_count,
    int32_t* out_count)
{
    ...
    *out_count = 0;
    ...
    const nvinfer1::ICudaEngine& engine_payload = context_payload->getEngine();
    const nvinfer1::Dims binding_dims = engine_payload.getBindingDimensions(binding_index);
    int32_t value_count = 0;
    if (binding_dims.nbDims > 0)
    {
    ...
    *out_count = value_count;
    ...
    if (value_count == 0 || output_count == 0)
    {
        return JYPPX_STATUS_OK;
    }
    ...
    const int32_t copy_count = output_count < value_count ? output_count : value_count;
    int32_t scratch[8]{};
    if (value_count > static_cast<int32_t>(std::size(scratch)))
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "Shape binding value count exceeds the fixed TensorRT dims scratch buffer.");
        return JYPPX_STATUS_BUFFER_TOO_SMALL;
    }

    const bool copied = context_payload->getShapeBinding(binding_index, scratch);
    if (!copied)
    {
        jyppx::common::set_last_error(JYPPX_ERROR_CATEGORY_TENSORRT, "IExecutionContext::getShapeBinding returned false.");
        return JYPPX_STATUS_RUNTIME_ERROR;
    }

    for (int32_t i = 0; i < copy_count; ++i)
    {
        output_values[i] = scratch[i];
    }

    return output_count >= value_count ? JYPPX_STATUS_OK : JYPPX_STATUS_BUFFER_TOO_SMALL;
#elif JYPPX_HAS_TENSORRT
    (void)context;
    (void)binding_index;
    (void)output_values;
    (void)output_count;
    return jyppx::tensorrt::report_vendor_mismatch(kLine, JYPPX_TENSORRT_VERSION_MAJOR_NUM, "execution context shape binding query");
#else
    (void)context;
    (void)binding_index;
    (void)output_values;
    (void)output_count;
    return jyppx::tensorrt::report_vendor_missing(kLine, "execution context shape binding query");
#endif
}
...
#define JYPPX_TRT_OUTPUT_ALLOCATOR_OWNER_API(name) jyppx_trt8_##name
...
#define JYPPX_TRT_ERROR_CODE_METADATA_API jyppx_trt8_error_code_get_exclusive_upper_bound
...
#include "modules/deferred/cross_version_ninth_batch_deferred.inc"
#include "modules/deferred/cross_version_tenth_batch_other_deferred.inc"
#include "modules/deferred/cross_version_eleventh_batch_plugin_deferred.inc"
