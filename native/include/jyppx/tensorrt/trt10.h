...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_builder_get_error_recorder_error(JYPPX_TensorRtBuilder* builder, int32_t index, JYPPX_TensorRtErrorRecordInfo* out_error);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_builder_get_error_recorder_snapshot_info(JYPPX_TensorRtBuilder* builder, JYPPX_TensorRtErrorRecorderSnapshotInfo* out_info);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_engine_inspector_get_error_recorder_error(JYPPX_TensorRtEngineInspector* inspector, int32_t index, JYPPX_TensorRtErrorRecordInfo* out_error);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_engine_inspector_get_error_recorder_snapshot_info(JYPPX_TensorRtEngineInspector* inspector, JYPPX_TensorRtErrorRecorderSnapshotInfo* out_info);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_network_get_error_recorder_error(JYPPX_TensorRtNetworkDefinition* network, int32_t index, JYPPX_TensorRtErrorRecordInfo* out_error);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_network_get_error_recorder_snapshot_info(JYPPX_TensorRtNetworkDefinition* network, JYPPX_TensorRtErrorRecorderSnapshotInfo* out_info);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_global_init_lib_nvinfer_plugins(JYPPX_TensorRtLogger* logger, const char* lib_namespace, JYPPX_Boolean* out_initialized);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_output_allocator_owner_create(JYPPX_TensorRtOutputAllocatorCallback callback, void* user_state, JYPPX_TensorRtOutputAllocatorOwner** out_owner);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_output_allocator_owner_attach(JYPPX_TensorRtOutputAllocatorOwner* owner, JYPPX_TensorRtExecutionContext* context, const char* tensor_name, JYPPX_Boolean* out_attached);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_output_allocator_owner_detach(JYPPX_TensorRtOutputAllocatorOwner* owner, JYPPX_Boolean* out_detached);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_output_allocator_owner_get_info(JYPPX_TensorRtOutputAllocatorOwner* owner, JYPPX_TensorRtOutputAllocatorOwnerInfo* out_info);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_gpu_allocator_owner_create(JYPPX_TensorRtGpuAllocatorCallback callback, void* user_state, JYPPX_TensorRtGpuAllocatorOwner** out_owner);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_gpu_allocator_owner_attach_runtime(JYPPX_TensorRtGpuAllocatorOwner* owner, JYPPX_TensorRtRuntime* runtime, JYPPX_Boolean* out_attached);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_gpu_allocator_owner_attach_builder(JYPPX_TensorRtGpuAllocatorOwner* owner, JYPPX_TensorRtBuilder* builder, JYPPX_Boolean* out_attached);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_gpu_allocator_owner_detach(JYPPX_TensorRtGpuAllocatorOwner* owner, JYPPX_Boolean* out_detached);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_gpu_allocator_owner_get_info(JYPPX_TensorRtGpuAllocatorOwner* owner, JYPPX_TensorRtGpuAllocatorOwnerInfo* out_info);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_global_plugin_registry_set_parent_search_enabled(JYPPX_Boolean enabled);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_onnx_parser_parse_with_weight_descriptors(JYPPX_TensorRtOnnxParser* parser, const void* model_data, size_t model_size, JYPPX_Boolean* out_parsed);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_onnx_parser_get_layer_output_tensor_metadata(JYPPX_TensorRtOnnxParser* parser, const char* layer_name, int64_t output_index, char* output_buffer, size_t output_buffer_size, size_t* out_required_size, JYPPX_Boolean* out_exists, JYPPX_TensorRtDims64* out_shape, int32_t* out_data_type, int32_t* out_location, uint32_t* out_allowed_formats, uint32_t* out_flags);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_stream_reader_v2_owner_create(const void* data, size_t size, JYPPX_TensorRtStreamReaderOwner** out_owner);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_stream_reader_v2_owner_get_info(JYPPX_TensorRtStreamReaderOwner* owner, JYPPX_TensorRtStreamReaderOwnerInfo* out_info);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_runtime_deserialize_stream_reader_v2(JYPPX_TensorRtRuntime* runtime, JYPPX_TensorRtStreamReaderOwner* owner, JYPPX_TensorRtCudaEngine** out_engine);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_execution_context_set_device_memory_v2(JYPPX_TensorRtExecutionContext* context, JYPPX_CudaMemory* memory);
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_execution_context_clear_device_memory_v2(JYPPX_TensorRtExecutionContext* context);
...
JYPPX_C_API(JYPPX_StatusCode) jyppx_trt10_execution_context_execute_v2_safe(JYPPX_TensorRtExecutionContext* context);
