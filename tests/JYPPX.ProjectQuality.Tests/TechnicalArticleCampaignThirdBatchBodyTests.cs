...
public sealed class TechnicalArticleCampaignThirdBatchBodyTests
{
    private static readonly string[] ArticleFiles =
    {
        ...
        "runtime-package-installation-deep-dive.md",
        "cuda-error-35-troubleshooting.md",
        "deferred-api-real-completion-review.md",
        "plugin-inventory-readonly-api.md",
        "package-consumer-runtime-proof-playbook.md",
    };

    [Fact]
    public void ThirdCampaignArticleBodyBatchExistsAndKeepsProofBoundaries()
    {
