...
public sealed class DeferredBTierWorkItemProofBatchTests
{
    ...
    public void AllCurrentBTierWorkItemsHaveSafeAlternativeProofWithoutDeletingDeferredHistory()
    {
        ...
        string focusedManagedApi = string.Join(
            ...
            ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtBuilderConfig.cs"),
            ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtBuilderConfig.Trt11RuntimeControls.cs"),
            ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtExecutionContext.cs"),
            ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtEngine.cs"),
            ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtLayer.cs"),
            ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtProfiler.cs"),
