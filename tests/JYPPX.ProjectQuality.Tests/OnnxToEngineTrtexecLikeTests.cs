...
public sealed class OnnxToEngineTrtexecLikeTests
{
    ...
    public void RuntimeArtifactWriterWritesBoundaryArtifactsWithoutPromotingBuildOnlyProof()
    {
        ...
        try
        {
            ...
            OnnxEngineBuildResult result = new OnnxEngineBuildResult(
                ...
                skipped: false,
                state: "build-only",
                tensorRtLine: JYPPX.TensorRtSharp.Shared.Interop.TensorRtApiLine.TensorRt10,
    ...
    public void BuildDiagnosticsIncludesBenchmarkSummaryWithoutPromotingProof()
    {
        ...
        OnnxEngineBuildResult result = new OnnxEngineBuildResult(
            ...
            skipped: false,
            state: "identity-roundtrip",
            tensorRtLine: JYPPX.TensorRtSharp.Shared.Interop.TensorRtApiLine.TensorRt11,
            modelSource: "embedded-dynamic-identity",
            enginePath: "model.plan",
            parsed: true,
            engineSaved: true,
    ...
    public void DeploymentPoliciesUseTypedSetReadbackAndExplicitVersionGuards()
    {
        ...
        string builder = File.ReadAllText(Path.Combine(RepositoryPaths.Root, "src", "JYPPX.TensorRtSharp", "Builder", "TensorRtBuilder.cs"));
    ...
    public void BuildReportCarriesCopiedBuilderConfigReadbackWithoutPromotingProof()
    {
        ...
        string service = ReadBuildService("Core", "Diagnostics");
...
""");
    ...
    {
        string service = ReadBuildService(
            "Core",
            "ResultCreation",
            "RuntimeExecution",
            "RuntimeInputs",
    ...
    public void OnnxToEngineProgramDelegatesBuildWorkToReusableService()
    {
        ...
        Assert.Contains("public sealed partial class OnnxEngineBuildService", service, StringComparison.Ordinal);
    ...
    private static string ReadBuildService(params string[] features)
    {
