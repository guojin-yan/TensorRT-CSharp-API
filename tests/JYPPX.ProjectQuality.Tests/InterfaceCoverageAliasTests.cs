...
public sealed class InterfaceCoverageAliasTests
{
    ...
    public void TensorRtBuilderAndDebugListenerAliasesPreferSafeBoundaryControls()
    {
        ...
        Assert.Contains("\"IErrorRecorder::getNbErrors\" = @(\"id:*runtime-get-error-recorder-snapshot-info\", \"id:*refitter-get-error-recorder-snapshot-info\", \"id:*builder-get-error-recorder-snapshot-info\", \"id:*network-get-error-recorder-snapshot-info\", \"id:*engine-inspector-get-error-recorder-snapshot-info\", \"id:*error-recorder-get-nb-errors-deferred\")", script);
        Assert.Contains("\"IErrorRecorder::getErrorCode\" = @(\"id:*runtime-get-error-recorder-error\", \"id:*refitter-get-error-recorder-error\", \"id:*builder-get-error-recorder-error\", \"id:*network-get-error-recorder-error\", \"id:*engine-inspector-get-error-recorder-error\", \"id:*error-recorder-get-error-code-deferred\")", script);
        Assert.Contains("\"IErrorRecorder::getErrorDesc\" = @(\"id:*runtime-get-error-recorder-error\", \"id:*refitter-get-error-recorder-error\", \"id:*builder-get-error-recorder-error\", \"id:*network-get-error-recorder-error\", \"id:*engine-inspector-get-error-recorder-error\", \"id:*error-recorder-get-error-desc-deferred\")", script);
        Assert.Contains("\"IErrorRecorder::getInterfaceInfo\" = @(\"id:*runtime-get-error-recorder-snapshot-info\", \"id:*refitter-get-error-recorder-snapshot-info\", \"id:*engine-get-error-recorder-snapshot-info\", \"id:*execution-context-get-error-recorder-snapshot-info\", \"id:*builder-get-error-recorder-snapshot-info\", \"id:*network-get-error-recorder-snapshot-info\", \"id:*engine-inspector-get-error-recorder-snapshot-info\", \"id:*error-recorder-get-interface-info-deferred\")", script);
        Assert.Contains("\"IErrorRecorder::hasOverflowed\" = @(\"id:*runtime-get-error-recorder-snapshot-info\", \"id:*refitter-get-error-recorder-snapshot-info\", \"id:*builder-get-error-recorder-snapshot-info\", \"id:*network-get-error-recorder-snapshot-info\", \"id:*engine-inspector-get-error-recorder-snapshot-info\", \"id:*error-recorder-has-overflowed-deferred\")", script);
