...
public sealed class EngineAndRnnReadonlyDiagnosticsTests
{
    ...
    public void ManagedInteropAndPublicApiExposeCompatibilityQueriesWithoutRawPointers()
    {
        ...
        string contextApi = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtExecutionContext.cs");
        string engineProfileValuesApi = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtEngine.Trt11FifteenthBatch.cs");
        string engineProfileValuesSnapshot = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtEngineProfileTensorValuesSnapshot.cs");
        ...
        string builderConfigApi = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtBuilderConfig.Trt11Diagnostics.cs");
        string layerApi = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtLayer.Trt8RnnV2Diagnostics.cs");
        string tensorApi = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtTensor.cs");
        string snapshotApi = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtRnnV2GateWeightsSnapshot.cs");
