...
public sealed class TechnicalArticleCampaignBodyTests
{
    private static readonly string[] ArticleFiles =
    {
        "tensorrtsharp-4-project-overview-campaign.md",
        "tensorrtsharp-4-architecture-abi-wrapper.md",
        "cuda-tensorrt-cudnn-version-matrix-guide.md",
        "tensorrtsharp-nuget-runtime-package-guide.md",
        "windows-installation-and-troubleshooting-guide.md",
        "linux-installation-runner-boundary-guide.md",
        "tensorrtexec-gui-cli-parity-design.md",
        "plugin-registry-inventory-readonly-design.md",
        "package-consumer-runtime-proof-clean-consumer-guide.md",
        "release-proof-and-post-publish-verification-guide.md",
        "tensorrtsharp-4-faq.md",
        "tensorrtsharp-4-release-story.md",
    };

    [Fact]
    public void FirstCampaignArticleBodyBatchExistsAndKeepsProofBoundaries()
    {
        Assert.InRange(ArticleFiles.Length, 8, 12);
