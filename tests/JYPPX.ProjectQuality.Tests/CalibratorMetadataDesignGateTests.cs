...
public sealed class CalibratorMetadataDesignGateTests
{
    ...
    {
        string gateSource = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtCalibratorMetadataDesignGate.cs");
        string builderConfig = ReadSource("src", "JYPPX.TensorRtSharp", "TensorRtBuilderConfig.cs");
